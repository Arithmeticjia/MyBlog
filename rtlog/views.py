...
from rtlog import models
from django.core.paginator import Paginator, EmptyPage, PageNotAnInteger
from MyBlog import settings
from .utils.common import ssh3, get_search_log_list, get_log_list, cleanup_log, execute_linux, write_log
...
def index(request):
    ...
    return render(request, "rtlog/index.html", data)
...
def view_dir(request):
    ...
    return render(request, "rtlog/view_dir.html", data)
