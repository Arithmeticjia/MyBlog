            ...
            <el-row type="flex" class="row-bg" justify="space-around">
              <el-col :span="20">
                <div class="grid-content bg-puprple-light">
                  <h1><a style="text-decoration: none;color: #2C3E50" :href="'/#/single'+ '/' + value.pk">{{ value.fields.title }}</a></h1>
                  <div>
                  ...
                  <el-button style="border-radius: 0px;" size="medium" @click="skiplocal('/#/single'+ '/' + value.pk)">阅读全文 >></el-button>
                </div>
                </br>
              </el-col>
            </el-row>
