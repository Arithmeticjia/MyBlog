    ...
    v1: {  // api 版本号
        codes: { // api v1 版本下的 code api。
            list: function () { //获取实例查询集
                return '/online-intepreter/api/v1/codes/'
            },
            detail: function (pk) { // 获取单一实例
                return `/online-intepreter/api/v1/codes/${pk}/`
            },
            ...
            run: function () { //运行代码
                return '/online-intepreter/api/v1/codes/run/'
            },
            runSave: function () {// 保存并运行代码
                return '/online-intepreter/api/v1/codes/run/?save=true'
            },
            runSpecific: function (pk) { // 运行特定代码实例
                return `/online-intepreter/api/v1/codes/run/${pk}/`
            },
            runSaveSpecific: function (pk) { // 运行并保存特定代码实例
                return `/online-intepreter/api/v1/codes/run/${pk}/?save=true`
            }
        }
    }
};
